...
// Pinned standalone bodies: these bytes may only change when the default
// emission itself deliberately does.
...
test("an alu pair emits its golden body", () => {
  ...
  strictEqual(
    ...
    "01027f41004100280200410028020c6a2200410028020c6a2201453a003741002001411f763a00384100200141ff017169" +
      "410171453a0035410020012000493a003441002000410028020c732001734104764101713a003641002000200173410028" +
      "020c20017371411f763a0039410020013602004100410028022c41026a36022c410041842036022042000f0b"
  );
});
...
test("a guarded load emits its golden body", () => {
  ...
  strictEqual(
    ...
    "01027f0240410028020c41046a210020003f0141107441046b4b0d002000284201002101410020013602004100410028022c" +
      "41016a36022c410041832036022042000f0b41004180203602202000ad4280808080d0808002840f0b"
  );
});
...
test("a compare and branch emits its golden body", () => {
  ...
  strictEqual(
    ...
    "01077f02400240410028020041056b22004521012000411f762102200041ff0171694101714521034100280200410549210" +
      "44100280200410573220520007341047641017121062005410028020020007371411f762100410028022c41026a21054100" +
      "2802004105460d010b410020013a0037410020023a0038410020033a0035410020043a0034410020063a0036410020003a00" +
      "394100200536022c410041852036022042000f0b410020013a0037410020023a0038410020033a0035410020043a00344100" +
      "20063a0036410020003a00394100200536022c410041a5203602204280808080100f0b"
  );
});

function emitGolden(byteLists: readonly (readonly number[])[]): string {
  const body = emitActionBlock(blockOf(byteLists), { body: new WasmFunctionBodyEncoder() });

  return Buffer.from(body.encode()).toString("hex");
}
