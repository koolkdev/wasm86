...
test("an alu pair emits its golden body", () => {
  ...
  strictEqual(
    ...
    "01027f41004100280200410028020c6a2200410028020c6a2201453a003741002001411f763a00384100200141ff017169" +
      ...
      "020c20017371411f763a003941002001360200410041842036022042000f0b"
  );
});
...
test("a guarded load emits its golden body", () => {
  ...
  strictEqual(
    ...
    "01027f0240410028020c41046a210020003f0141107441046b4b0d00200028420100210141002001360200410041832036" +
      "022042000f0b41004180203602202000ad4280808080d0808002840f0b"
  );
});
...
test("a compare and branch emits its golden body", () => {
  ...
  strictEqual(
    ...
    "01077f02400240410028020041056b22004521012000411f762102200041ff0171694101714521034100280200410549210" +
      "44100280200410573220520007341047641017121062005410028020020007371411f76210041002802004105460d010b41" +
      "0020013a0037410020023a0038410020033a0035410020043a0034410020063a0036410020003a0039410041852036022042" +
      "000f0b410020013a0037410020023a0038410020033a0035410020043a0034410020063a0036410020003a0039410041a520" +
      "3602204280808080100f0b"
  );
});
