...
test("a compare and branch emits its golden body", () => {
  ...
  strictEqual(
    ...
    "01027f02404100280218220041054641002802900141026a21010440410041a5203602384100200036020441004105360208" +
      "410041093a000041002001360290010c010b41004185203602384100200036020441004105360208410041093a0000" +
      "41002001360290010c000b427f0b"
  );
});
