...
test("an alu pair emits its golden body", () => {
  ...
  strictEqual(
    ...
    "01027f41004100280200410028020c6a2200410028020c6a220136020041004184203602204100410028022441026a360224410020012000493a00294100200141ff017169410171453a002a" +
      "41002000410028020c732001734104764101713a002b41002001453a002c41002001411f763a002d41002000200173410028020c" +
      "20017371411f763a002e410041003a0028427f0b"
  );
});
...
test("a compare and branch emits its golden body", () => {
  ...
  strictEqual(
    ...
    "01087f410028022441026a210041002802004105492101410028020041056b220241ff01716941017145210341002802004105732204" +
      ...
      "360224410020013a0029410020033a002a410020053a002b410020063a002c410020073a002d410020023a002e410041003a0028" +
      "05410041852036022041002000360224410020013a0029410020033a002a410020053a002b410020063a002c410020073a002d410020023a002e410041003a00280b427f0b"
  );
});
