...
test("an alu pair emits its golden body", () => {
  ...
  strictEqual(
    ...
    "01027f41004100280200410028020c6a2200410028020c6a220136020041004184203602204100410028022441026a360224410020012000493a002c4100200141ff017169410171453a002d" +
...
test("a compare and branch emits its golden body", () => {
  ...
  strictEqual(
    ...
    "01087f410028022441026a210041002802004105492101410028020041056b220241ff01716941017145210341002802004105732204" +
      ...
      "360224410020013a002c410020033a002d410020053a002e410020063a002f410020073a0030410020023a0031" +
      "05410041852036022041002000360224410020013a002c410020033a002d410020053a002e410020063a002f410020073a0030410020023a00310b427f0b"
  );
});
