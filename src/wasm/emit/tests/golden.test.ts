...
test("an alu pair emits its golden body", () => {
  ...
  strictEqual(
    ...
    "01017f41004100280200410028020c6a2200410028020c6a36020041004184203602204100200036022c4100410028020c360230" +
      "4100410028022441026a36022441004182013a0028427f0b"
  );
});
...
test("a compare and branch emits its golden body", () => {
  ...
  strictEqual(
    ...
    "01017f410028022441026a210041002802004105460440410041a5203602204100410028020036022c4100410536023041004181013a0028" +
      "410020003602240541004185203602204100410028020036022c4100410536023041004181013a0028410020003602240b427f0b"
  );
});
