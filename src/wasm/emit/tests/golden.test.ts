...
test("an alu pair emits its golden body", () => {
  ...
  strictEqual(
    ...
    "01027f024041004100280200410028020c22006a220120006a3602004100200136022c410020003602304100" +
      "410028022441026a3602244100410a3a002841004184203602200c000b427f0b"
  );
});
...
test("a live-in branch condition emits its lazy switch golden body", () => {
  ...
  strictEqual(
    ...
    "01017f02400240024002400240024002400240024041002d00280e0c060006010602060306040605060b41002d002c41002d0030" +
      ...
      "410028022c41002802304621000c020b410028022c4521000c010b100021000b200004404100410028022441016a360224" +
      "410041a2203602200c010b4100410028022441016a36022441004182203602200c000b427f0b"
  );
});
...
test("a live-in setcc condition emits its lazy switch golden body", () => {
  ...
  strictEqual(
    ...
    "01017f02400240024002400240024002400240024041002d00280e0c060006010602060306040605060b41002d002c41002d0030" +
      ...
      "4100410028022441016a36022441004183203602200c000b427f0b"
  );
});
