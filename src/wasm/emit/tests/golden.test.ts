...
test("an alu pair emits its golden body", () => {
  ...
  strictEqual(
    ...
    "01027f41004100280200410028020c6a2200410028020c6a220136020041004184203602204100410028022441026a360224410020012000493a00344100200141ff017169410171453a0035" +
      "41002000410028020c732001734104764101713a003641002001453a003741002001411f763a003841002000200173410028020c" +
      "20017371411f763a0039410041003b0128427f0b"
  );
});
...
test("a compare and branch emits its golden body", () => {
  ...
  strictEqual(
    ...
    "01087f410028022441026a210041002802004105492101410028020041056b220241ff01716941017145210341002802004105732204" +
      "200273410476410171210520024521062002411f7621072004410028020020027371411f76210241002802004105460440410041a52036022041002000" +
      "360224410020013a0034410020033a0035410020053a0036410020063a0037410020073a0038410020023a0039410041003b0128" +
      "05410041852036022041002000360224410020013a0034410020033a0035410020053a0036410020063a0037410020073a0038410020023a0039410041003b01280b427f0b"
  );
});
