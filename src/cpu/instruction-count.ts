...
export const instructionCountField = new FieldRef("cpu.execution.instruction-count", "u32");

export const instructionLimitField = new FieldRef("cpu.execution.instruction-limit", "u32");
